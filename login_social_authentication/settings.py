...
ALLOWED_HOSTS = [os.getenv("HOST"), "progdude.info", "127.0.0.1",]
...
ROOT_URLCONF = 'login_social_authentication.urls'
...
WSGI_APPLICATION = 'login_social_authentication.wsgi.application'
